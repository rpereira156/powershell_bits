<#
.CREDITS
All credit goes to TheSleepyAdmin and the original code can be found at https://github.com/TheSleepyAdmin/Scripts/blob/ad14cda3a8f8e3852e5c05b023074adfd463a4f0/General/Scheduled%20task/Check_RunAsAccount.ps1
